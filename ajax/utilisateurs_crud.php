<?php
    ...
    //     $nom_q = select("SELECT * FROM utilisateurs WHERE email=?", [$email], "s");
    //     $nom_r = mysqli_fetch_assoc($nom_q);
        

    //     if($type == 'email_confirmation'){
    //         $page = 'email_confirm.php';
    //         $subject = "Verification compte pour Gestion reservation MAGIK CITY";

    //         $htmlContent = "
    //         <div style='max-width: 600px; margin: 0 auto; background-color: #f8f9fa; padding: 20px; border-radius: 5px; font-family: Arial, sans-serif;'>
    //             <div style='background-color: #007bff; color: white; text-align: center; padding: 15px; border-top-left-radius: 5px; border-top-right-radius: 5px;'>
    //                 <h2>Email Confirmation</h2>
    //             </div>
    //             <div style='padding: 20px; font-size: 16px; color: #333;'>
    //                 <p>Merci de votre inscription. Veuillez confirmer votre adresse e-mail en cliquant sur le lien ci-dessous:</p>
    //                 <p><a href='" . SITE_URL . "$page?$type&email=$email&token=$token' style='color: #007bff;'>Cliquer ici pour verifier votre compte.</a></p>
    //             </div>
    //         </div>
    //         <div style='text-align: center; font-size: 14px; color: #a89c9c; padding: 15px;'>
    //             Gestion reservation MAGIK CITY
    //         </div>";
    //     }else{
    //         $nom = $nom_r['nom'];
    //         $page = "index.php";
    //         $subject = "Demande de réinitialisation de mot de passe pour Gestion reservation MAGIK CITY";

    //         $htmlContent = "
    //         <div style='max-width: 600px; margin: 0 auto; background-color: #f8f9fa; padding: 20px; border-radius: 5px; font-family: Arial, sans-serif;'>
    //             <div style='background-color: #b71c1c; color: white; text-align: center; padding: 15px; border-top-left-radius: 5px; border-top-right-radius: 5px;'>
    //                 <h2>Demande de réinitialisation du mot de passe</h2>
    //             </div>
    //             <div style='padding: 20px; font-size: 16px; color: #333;'>
    //                 <p>Salut $nom,</p>
    //                 <p>Quelqu’un a demandé un nouveau mot de passe pour le compte suivant sur Gestion reservation MAGIK CITY:</p>
    //                 <p>Si vous n’avez pas fait cette demande, ignorez simplement cet e-mail. Si vous souhaitez continuer:</p>
    //                 <p><a href='" . SITE_URL . "$page?$type&email=$email&token=$token' style='color: #b71c1c;'>Cliquez ici pour réinitialiser votre mot de passe</a></p>
    //             </div>
    //         </div>
    //         <div style='text-align: center; font-size: 14px; color: #a89c9c; padding: 15px;'>
    //             Gestion reservation MAGIK CITY
    ...
    //     $config = Configuration::getDefaultConfiguration()->setApiKey('api-key', SEND_API_KEY);
    //     $apiInstance = new TransactionalEmailsApi(new Client(),$config);
    //     // magiccityfunparkcap
    //     $emailsend = [
    //         'sender' => ['email' => 'ebsonde.norcilien00@gmail.com', 
    //         'name' => 'Gestion reservation MAGIK CITY'],
    //         'to' => [['email' => $email]],
    //         'subject' => $subject,
    ...
    //     try{
    //         $result = $apiInstance->sendTransacEmail($emailsend);
    //         return 1;
    //     }catch(Exception $e){
    //         return 0;
    //     }
